...
from .stock_info_service import individual_stock_trend
...
def register(mcp: FastMCP) -> None:
    ...
    def individual_stock_trend_tool(stock_name: str, target_date: str) -> dict:
        """
        Args:
        ...
        return individual_stock_trend(s, t)
